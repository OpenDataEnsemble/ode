...
// Last generated: 2026-06-19T16:58:11.324Z
          ...
          const callback = (event) => {
            try {
              ...
              if (typeof event.data === 'string') {
                ...
                window.removeEventListener('message', callback); // Clean up listener
                reject(new Error('getCachedLocation callback: Received response with unexpected data type. Raw: ' + String(event.data)));
                return;
              }
              if (data.type === 'getCachedLocation_response' && data.messageId === messageId) {
                window.removeEventListener('message', callback);
                if (data.error) {
                  reject(new Error(data.error));
                } else {
              ...
              console.error("'getCachedLocation' callback: Error processing response:" , e, "Raw event.data:", event.data);
              window.removeEventListener('message', callback); // Ensure listener is removed on error too
              reject(e);
            }
          };
          ...
          const callback = (event) => {
            try {
              ...
              if (typeof event.data === 'string') {
                ...
                window.removeEventListener('message', callback); // Clean up listener
                reject(new Error('allocateSequence callback: Received response with unexpected data type. Raw: ' + String(event.data)));
                return;
              }
              if (data.type === 'allocateSequence_response' && data.messageId === messageId) {
                window.removeEventListener('message', callback);
                if (data.error) {
                  reject(new Error(data.error));
                } else {
              ...
              console.error("'allocateSequence' callback: Error processing response:" , e, "Raw event.data:", event.data);
              window.removeEventListener('message', callback); // Ensure listener is removed on error too
              reject(e);
            }
          };
          ...
          const callback = (event) => {
            try {
              ...
              if (typeof event.data === 'string') {
                ...
                window.removeEventListener('message', callback); // Clean up listener
                reject(new Error('watchLocation callback: Received response with unexpected data type. Raw: ' + String(event.data)));
                return;
              }
              if (data.type === 'watchLocation_response' && data.messageId === messageId) {
                window.removeEventListener('message', callback);
                if (data.error) {
                  reject(new Error(data.error));
                } else {
              ...
              console.error("'watchLocation' callback: Error processing response:" , e, "Raw event.data:", event.data);
              window.removeEventListener('message', callback); // Ensure listener is removed on error too
              reject(e);
            }
          };
          ...
          const callback = (event) => {
            try {
              ...
              if (typeof event.data === 'string') {
                ...
                window.removeEventListener('message', callback); // Clean up listener
                reject(new Error('stopWatchLocation callback: Received response with unexpected data type. Raw: ' + String(event.data)));
                return;
              }
              if (data.type === 'stopWatchLocation_response' && data.messageId === messageId) {
                window.removeEventListener('message', callback);
                if (data.error) {
                  reject(new Error(data.error));
                } else {
              ...
              console.error("'stopWatchLocation' callback: Error processing response:" , e, "Raw event.data:", event.data);
              window.removeEventListener('message', callback); // Ensure listener is removed on error too
              reject(e);
            }
          };
          ...
          const callback = (event) => {
            try {
              ...
              if (typeof event.data === 'string') {
                ...
                window.removeEventListener('message', callback); // Clean up listener
                reject(new Error('requestVideo callback: Received response with unexpected data type. Raw: ' + String(event.data)));
                return;
              }
              if (data.type === 'requestVideo_response' && data.messageId === messageId) {
                window.removeEventListener('message', callback);
                if (data.error) {
                  reject(new Error(data.error));
                } else {
              ...
              console.error("'requestVideo' callback: Error processing response:" , e, "Raw event.data:", event.data);
              window.removeEventListener('message', callback); // Ensure listener is removed on error too
              reject(e);
            }
          };
          ...
          const callback = (event) => {
            try {
              ...
              if (typeof event.data === 'string') {
                ...
                window.removeEventListener('message', callback); // Clean up listener
                reject(new Error('persistObservation callback: Received response with unexpected data type. Raw: ' + String(event.data)));
                return;
              }
              if (data.type === 'persistObservation_response' && data.messageId === messageId) {
                window.removeEventListener('message', callback);
                if (data.error) {
                  reject(new Error(data.error));
                } else {
              ...
              console.error("'persistObservation' callback: Error processing response:" , e, "Raw event.data:", event.data);
              window.removeEventListener('message', callback); // Ensure listener is removed on error too
              reject(e);
            }
          };
          ...
          const callback = (event) => {
            try {
              ...
              if (typeof event.data === 'string') {
                ...
                window.removeEventListener('message', callback); // Clean up listener
                reject(new Error('sync callback: Received response with unexpected data type. Raw: ' + String(event.data)));
                return;
              }
              ...
              console.error("'sync' callback: Error processing response:" , e, "Raw event.data:", event.data);
              window.removeEventListener('message', callback); // Ensure listener is removed on error too
              reject(e);
            }
          };
          ...
          const callback = (event) => {
            try {
              ...
              if (typeof event.data === 'string') {
                ...
                window.removeEventListener('message', callback); // Clean up listener
                reject(new Error('getConnectivityStatus callback: Received response with unexpected data type. Raw: ' + String(event.data)));
                return;
              }
              if (data.type === 'getConnectivityStatus_response' && data.messageId === messageId) {
                window.removeEventListener('message', callback);
                if (data.error) {
                  reject(new Error(data.error));
                } else {
              ...
              console.error("'getConnectivityStatus' callback: Error processing response:" , e, "Raw event.data:", event.data);
              window.removeEventListener('message', callback); // Ensure listener is removed on error too
              reject(e);
            }
          };
          ...
          const callback = (event) => {
            try {
              ...
              if (typeof event.data === 'string') {
                ...
                window.removeEventListener('message', callback); // Clean up listener
                reject(new Error('getCurrentDataRevisionCount callback: Received response with unexpected data type. Raw: ' + String(event.data)));
                return;
              }
              if (data.type === 'getCurrentDataRevisionCount_response' && data.messageId === messageId) {
                window.removeEventListener('message', callback);
                if (data.error) {
                  reject(new Error(data.error));
                } else {
              ...
              console.error("'getCurrentDataRevisionCount' callback: Error processing response:" , e, "Raw event.data:", event.data);
              window.removeEventListener('message', callback); // Ensure listener is removed on error too
              reject(e);
            }
          };
