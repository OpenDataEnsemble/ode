...
export type ObservationMetaField = 'observation_id' | 'form_type' | 'form_version' | 'deleted' | 'created_at' | 'updated_at' | 'author' | 'device_id';
...
export type ObservationFilter = ObservationCondition | ObservationQuantifier | ObservationLogical;
