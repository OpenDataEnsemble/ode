...
class WebViewMock {
  ...
  private pendingCameraPromises = new Map<
    string,
    {
      ...
      reject: (result: CameraResult) => void;
    }
  >();
  ...
  private pendingAudioPromises = new Map<
    string,
    {
      ...
      reject: (result: AudioResult) => void;
    }
  >();
  private pendingLocationPromises = new Map<
    string,
    {
      ...
      reject: (result: LocationResult) => void;
    }
  >();
  private pendingVideoPromises = new Map<
    string,
    {
      ...
      reject: (result: VideoResult) => void;
    }
  >();
